...
CREATE TABLE backup_operations_new (
	...
	operation_type TEXT NOT NULL
		CHECK (operation_type IN ('create', 'restore', 'repository_move', 'restore_preview')),
	...
	preview_added_files INTEGER,
	preview_modified_files INTEGER,
	preview_deleted_files INTEGER,
	preview_plan_token TEXT
);
